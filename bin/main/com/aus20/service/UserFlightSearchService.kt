...
class UserFlightSearchService(
    ...
    private val inputDateFormatterForSave = DateTimeFormatter.ofPattern("MMM d,uuuu", Locale.ENGLISH)
   ...
   */
    ...
    */
    ...
    /**
     * Sadece kullanıcının arama kriterlerini (uçuşları değil) kaydeder.
     * Eğer arama zaten varsa, mevcut aramayı döner, yoksa yenisini kaydeder ve döner.
     */
